(function () {
    ...
    async function loadStatus() {
        ...
        try {
            ...
            console.error(
                "[VUR V1.0.3] Erro ao verificar ligações",
                error
            );
    ...
    async function verifyUser() {
        console.log(
            "[VUR V1.0.3] Clique em verificar utilizador"
        );
        ...
        try {
            ...
            console.error(
                "[VUR V1.0.3] Erro no diagnóstico",
                error
            );
    ...
    if (!state.initialized) {
        ...
        console.log(
            "[VUR V1.0.3] Delegação global instalada."
        );
    }
    ...
    function waitForModule() {
        ...
        function check() {
            ...
            if (attempts < maxAttempts) {
                ...
                console.warn(
                    "[VUR V1.0.3] Página do módulo não foi localizada."
                );
            }
        }
    ...
    console.log(
        "[VUR V1.0.3] script.js executado."
    );
})();