...
const AM_SERVICENOW_URL = "https://santander.service-now.com/";
...
async function amApi(payload) {
    ...
    const url = `/module/acesso-em-massa/api?action=${action}&payload=${encodeURIComponent(jsonPayload)}`;
